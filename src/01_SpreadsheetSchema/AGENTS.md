...
- **Regenerate the three files in `generated/` together with `npm run app:gen:configs`, never a subset**, and never edit their data by hand, floor entries included: fix the live tab or the seed.
